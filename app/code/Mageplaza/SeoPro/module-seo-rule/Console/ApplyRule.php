    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($id = $input->getOption(self::INPUT_KEY_RULE_ID)) {
            ...
            if ($ruleModel->getStatus()) {
                ...
                $output->writeln("This rule is disabled. Please enable it before apply.");
            }
        } else {
            $result = $this->helperData->applyRules();
