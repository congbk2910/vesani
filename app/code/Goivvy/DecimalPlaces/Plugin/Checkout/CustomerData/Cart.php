...
namespace Goivvy\DecimalPlaces\Plugin\Checkout\CustomerData;
...
class Cart
{
    ...
    public function afterGetSectionData(\Magento\Checkout\CustomerData\Cart $subject, $result)
    {
        ...
        $priceHelper = $objectManager->create('Goivvy\DecimalPlaces\Pricing\Helper\Data'); // Instance of Pricing Helper
        $result['subtotal_incl_tax'] = $priceHelper->currency($this->getSubtotalInclTax(), true, true);
        $result['subtotal_excl_tax'] = $priceHelper->currency($this->getSubtotalExclTax(), true, true);
